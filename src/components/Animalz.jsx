      ...
      <div className="modal_project">
        <div className="explain_project">
          <p>
            ...
            training. This is a site that allows you to connect single
            travelers, who would like to share a trip with someone who shares
            the same desires. This project was carried out in collaboration with
            3 comrades for a period of 24 hours, during our 3rd month of
            training. Constraints imposed: the theme: holidays, maximum
