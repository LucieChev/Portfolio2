  ...
  return (
    <div className="modal_page">
      <div className="explain_project">
        <p>
          This is our #1 project, done as part of our Wild Code School training.
          This is a quiz that allows you to discover the city of Lyon. This
          project was carried out in collaboration with 2 comrades for a period
          of 2 weeks, during our 1st month of training. Constraints imposed:
          HTML, CSS and JAVASCRIPT Vanilla and Git/GitHub for versioning. We
          also used LEAFLET.
        </p>
      </div>
